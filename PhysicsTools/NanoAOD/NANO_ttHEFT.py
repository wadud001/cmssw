...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
      'root://deepthought.crc.nd.edu//store/user/kmohrman/postLHE_step/FullR2Studies/ULChecks/ttXJet-tXq_testFullULWF_ULCheck_UL17/v2/mAOD_step_ttllNuNuJetNoHiggs_testUpdateGenproddim6TopMay20GST_run2/MAOD-00000_4157.root',
